Header.find_or_create_by!( title: 'Innovis Law Partners', subtitle: 'Everything in Legal solutions', description: 'IPR | Corporate | Civil | Criminal')
...
TeamMember.create([
  { name: 'Ankur Pastor',  designation: 'Managing Partner' },
  { name: 'Ayush Bharadwaj',  designation: 'Senior Associate' },
  { name: 'Shubhi Dubey',  designation: 'Partner' },
  { name: 'Mohit Soni',  designation: 'Senior Associate' },
  { name: 'Rishabh Mishra',  designation: 'Partner' },
  { name: 'Kanishka Jain',  designation: 'Associate' },
  { name: 'Aviral Aind',  designation: 'Associate' },
  { name: 'Khushi Palawat',  designation: 'Associate' },
  { name: 'Hemant Bishnoi',  designation: 'Associate' },
  { name: 'Akshita Singh',  designation: 'Associate' }
])
...
Service.create(
  [
    { title: 'Intellectual Property Rights', description: 'We specialize in the dynamic realm of intellectual property law, encompassing TRADEMARK, COPYRIGHT.', slug: 'intellectual-property-rights' },
    { title: 'Startup Advisory and Compliance', description: 'We have a proven track record of supporting early-stage startups worldwide, leveraging our extensive industry experience.', slug: 'startup-advisory-and-compliance' },
    { title: 'MSME Litigation and Compliance', description: 'We understand the unique legal needs and challenges faced by Micro, Small, and Medium Enterprises (MSMEs).', slug: 'msme-litigation-and-compliance' },
    { title: 'Employment Law', description: 'We have extensive experience advising on labor, employment, social security, and industrial relation laws.', slug: 'employment-law' },
    { title: 'Real Estate Regulation and Development Services', description: 'We offer specialized legal services to assist clients in navigating the intricacies of real estate regulation.', slug: 'real-estate-regulation-and-development-services' },
    { title: 'Environmental Law', description: 'Our legal team possesses extensive experience in both civil and criminal environmental litigation matters.', slug: 'environmental-law' },
    { title: 'Sports Law', description: 'With a deep understanding of the sports industry, we offer comprehensive knowledge in all aspects of sports litigation.', slug: 'sports-law' },
    { title: 'TMT Law', description: 'Our TMT services stand at the forefront of the industry, providing clients with cutting-edge insights and solutions.', slug: 'tmt-law' },
    { title: 'Arbitration And Conciliation', description: 'We help our clients to resolve conflict more easily and swiftly without it becoming the matter of litigation. It is beneficial for both the parties to resolve a dispute at the earliest.', slug: 'arbitration-and-conciliation' },
    { title: 'Startups', description: 'We provide our clients with proper legal counsel during the formation of their startups. It’s the most crucial point when careful documentation and strategic efficiencies are crucial to their success.', slug: 'startup' },
    { title: 'Corporate Laws', description: 'We deal with complex corporate transactions which deal with foreign direct investment and overseas direct investments. We are known for the quality of service that we provide.', slug: 'corporate-laws' },
    { title: 'Legal Audits', description: 'Our legal auditing will help our clients to isolate any inappropriate or inefficient billing practice that will unnecessarily increase their legal fees.', slug: 'legal-audits' }
...
if CountSection.count == 0
  section1 = CountSection.create(number: '10+', text: 'Years in Business')

  section2 = CountSection.create(number: '1500+', text: 'Successful Cases')

  section3 = CountSection.create(number: '1000+', text: 'Satisfied Clients')

  section4 = CountSection.create(number: '25+', text: 'Pro Consultants')
end
